          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 max-w-2xl">
              ...
              <p className="text-zinc-400 text-lg">
                We offer a full suite of SEO services, tailored to your industry,
                goals, and budget.
              </p>
            </div>
              ...
              {[
                {
                  icon: "⚡",
                  title: "Technical SEO",
                  desc: "Core Web Vitals, crawlability, indexation, site architecture, and speed optimization — the foundation every site needs.",
                },
                {
                  icon: "🔗",
                  title: "Link Building",
                  desc: "White-hat authority building through digital PR, editorial placements, and strategic partnerships that move rankings.",
                },
                {
                  icon: "✍️",
                  title: "Content Strategy",
                  desc: "Keyword-mapped content plans, topical authority clusters, and high-intent copy that converts organic visitors.",
                },
                {
                  icon: "📍",
                  title: "Local SEO",
                  desc: "Dominate Google Maps and local pack results. Perfect for multi-location businesses and service-area companies.",
                },
                {
                  icon: "🛒",
                  title: "Ecommerce SEO",
                  desc: "Category page optimization, product schema, faceted navigation, and merchant feed strategies for DTC brands.",
                },
                {
                  icon: "📊",
                  title: "SEO Analytics",
                  desc: "Custom dashboards, rank tracking, attribution reporting, and monthly strategy reviews tied to revenue impact.",
                },
              ].map((service) => (
                <div
                  key={service.title}
                  className="group bg-white/[0.03] hover:bg-purple-600/10 border border-white/5 hover:border-purple-500/30 rounded-2xl p-7 transition-all duration-200"
                >
              ...
              {[
                {
                  ...
                  desc: "We analyze your site, competitors, and keyword landscape to uncover every growth opportunity.",
                },
                {
                  step: "02",
                  title: "Custom Roadmap",
                  desc: "You receive a prioritized 90-day plan with clear milestones, deliverables, and projected outcomes.",
                },
                {
                  step: "03",
                  title: "Execution Sprint",
                  desc: "Our team builds links, ships content, and fixes technical issues at a pace that compounds.",
                },
                {
                  step: "04",
                  title: "Report & Iterate",
                  desc: "Monthly reports track every ranking, click, and conversion. We refine based on data, not guesswork.",
                },
              ].map((item) => (
              ...
              {[
                {
                  ...
                  detail: "Rebuilt site architecture, fixed 1,200+ technical issues, and shipped 80 pieces of pillar content.",
                ...
                },
                {
                  ...
                  industry: "Ecommerce",
                  metric: "3.8×",
                  metricLabel: "Revenue from organic search",
                  detail: "Category SEO overhaul, 140 editorial backlinks, and product schema implementation.",
                ...
                },
                {
                  ...
                  metric: "#1",
                  metricLabel: "Local pack in 12 target cities",
                  detail: "Citation cleanup, Google Business optimization, and geo-targeted content strategy.",
                  color: "from-purple-900/40 to-indigo-800/10",
                },
              ].map((cs) => (
                <div
                  key={cs.company}
                  className={`bg-gradient-to-b ${cs.color} border border-white/8 rounded-2xl p-8`}
                >
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="bg-purple-600/20 text-purple-300 text-xs font-semibold px-3 py-1 rounded-full">
                      {cs.industry}
                    </span>
                  </div>
        ...
        <section id="testimonials" className="py-28 px-6 bg-white/[0.02]">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-5">
              {[
                {
                  quote: "RankForge took us from page 3 to the top 3 positions for our most competitive keywords in under four months. The ROI has been extraordinary.",
                  name: "Sarah K.",
                  role: "VP of Marketing, Fintech startup",
                },
                {
                  quote: "Most SEO agencies talk a big game. RankForge delivers. They built 60 editorial links in 90 days and our domain authority jumped 18 points.",
                  name: "James R.",
                ...
                },
                {
                  ...
                  name: "Priya M.",
                  role: "Head of Growth, Ecommerce brand",
                },
                {
                  ...
                  name: "Tom B.",
                  role: "Owner, Multi-location services",
                },
                {
                ...
                },
                {
                  ...
                  name: "Marcus D.",
                  role: "Content Director, B2B platform",
                },
              ].map((t) => (
                <div
                  key={t.name}
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-zinc-400 text-lg max-w-xl mx-auto">
                No lock-in contracts. Cancel anytime. Every plan includes a dedicated strategist.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-6">
              {[
                {
                  ...
                  price: "$2,500",
                  period: "/mo",
                  desc: "For startups and SMBs getting serious about organic.",
                  features: [
                    "Technical SEO audit",
                    "10 content pieces/mo",
                    "5 link placements/mo",
                    "Monthly reporting",
                ...
                },
                {
                  ...
                  price: "$5,500",
                  period: "/mo",
                  desc: "For established companies ready to dominate their niche.",
                  features: [
                    "Everything in Launch",
                    "20 content pieces/mo",
                    "15 link placements/mo",
                    "Weekly reporting",
                ...
                },
                {
                  ...
                  price: "Custom",
                  period: "",
                  desc: "For large sites, agencies, and multi-brand portfolios.",
                  features: [
                    "Everything in Scale",
                    "Unlimited content",
                ...
                <div
                  ...
                  className={`rounded-2xl p-8 flex flex-col ${
                    plan.highlight
                      ? "bg-purple-600 border-2 border-purple-400 shadow-xl shadow-purple-900/40"
            ...
            <div className="relative bg-gradient-to-br from-purple-900/60 to-violet-900/40 border border-purple-500/20 rounded-3xl px-10 py-16 text-center overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-zinc-300 text-lg mb-10 max-w-xl mx-auto">
                  Book a free 30-minute strategy call. We&apos;ll audit your site,
                  review your competitors, and show you exactly where the
                  opportunities are.
                </p>
                <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                  <input
                    ...
                    className="flex-1 bg-white/10 border border-white/10 text-white placeholder-zinc-500 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  />
                  <button
                    type="submit"
                    className="bg-purple-600 hover:bg-purple-500 transition-colors text-white font-semibold px-6 py-3 rounded-xl text-sm whitespace-nowrap"
                  >
                    Get Free Audit
                  </button>
                </form>
