...
export function KpiCard({ data }: { data: KpiCardData }) {
  ...
  const stroke = positive ? "#059669" : negative ? "#e11d48" : "#a78bfa";
    ...
    <div className="px-4 py-3">
      ...
      <div className="h-10 mt-1">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data.spark} margin={{ top: 2, right: 0, bottom: 0, left: 0 }}>
            <defs>
            ...
            <Area type="monotone" dataKey="value" stroke={stroke} strokeWidth={1.5} fill={`url(#spark-${data.label})`} />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
