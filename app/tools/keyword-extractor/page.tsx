  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 px-6 h-14 flex items-center gap-3">
        ...
        <span className="text-sm font-semibold text-gray-900">Seed Keyword Extractor</span>
      </header>
            ...
            <div className="mt-8 flex flex-col gap-4">
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div className="px-5 py-3 bg-gray-50 border-t border-gray-100">
                  <p className="text-xs text-gray-400">Scores are 1–100 (higher = more relevant)</p>
                </div>
              </div>
            </div>
          )}
